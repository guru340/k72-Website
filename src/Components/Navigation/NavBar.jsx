...
const Navbar = () => {
    ...
    return (
        <div className='z-40 flex fixed top-0 w-full items-start justify-between pointer-events-none'>
            ...
            <Link to='/' className='lg:p-5 p-3 pointer-events-auto block'>
            ...
            <div
                ...
                className='lg:h-16 h-10 bg-black relative lg:w-[16vw] w-40 cursor-pointer pointer-events-auto'
            >
                <div ref={navGreenRef} className='bg-[#D3FD50] transition-all duration-300 absolute top-0 h-0 w-full' />
                <div className='relative h-full lg:px-12 px-6 flex flex-col justify-center items-end lg:gap-1.5 gap-1'>
                    <div className="lg:w-18 w-10 h-0.5 bg-white" />
